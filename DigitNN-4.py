...
if __name__ == '__main__':
    ...
    layers = [
        Layer(784,   512,   ReLU,        ReLU_derivative),
        Layer(512,  512,   ReLU,        ReLU_derivative),
        Layer(512,  10,     Softmax,     None)
    ]
    nn = NeuralNetwork(layers)

    # 4. Train the network
    nn.train(x_train, y_train, iterations=100, alpha=0.1, print_every=5)
