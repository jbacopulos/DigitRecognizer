...
if __name__ == '__main__':
    ...
    layers = [
        Layer(784,   32,     ReLU,        ReLU_derivative),
        Layer(32,    32,     ReLU,        ReLU_derivative),
        Layer(32,    32,     ReLU,        ReLU_derivative),
        Layer(32,    10,     Softmax,     None)
    ]
    nn = NeuralNetwork(layers)

    # 4. Train the network
    nn.train(x_train, y_train, iterations=400, alpha=0.075, print_every=20)
